  ...
  return (
    <>
      {noWeatherData !== "past" ?
        ...
        <div className="text">The Weather Forecast will be available two weeks before the Event starts.</div>
        :        
        Object.keys(weatherData).length > 0 ? (
          <div className="weather-info">
            ...
            <div className="weather-icon">
              <img
                src={weatherData.forecast.forecastday[0].hour[0].condition.icon}
              />
            </div>
